...
ingress.networking.k8s.io/app-ingress-by-nginx   nginx   app.vm30.handson.cloudnativedays.jp   10.96.54.28   80      3m9s
```

ブラウザから`http://app.vm30.handson.cloudnativedays.jp`に接続し、下記のような画面が表示されることを確認してください。
